...
from Resturant.EnrichOutlet.Config import config, layer
from Resturant.EnrichOutlet.Harmonisation import Harmonizer
...
def main(table, loadtype,runtype='prod'):
    logging = Logger(notebook_name='Process_EnrichOutlet')
